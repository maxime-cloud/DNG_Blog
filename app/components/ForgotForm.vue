<template>
  ...
  <div v-else class="p-8 flex flex-col rounded-none ring-0 items-center justify-center w-full max-w-md  bg-CustomLight dark:bg-CustomColor-900 relative shadow-[6px_-7px_24px_0px_rgb(0,0,0, 0.51)] shadow-[-6px_7px_24px_0px_rgb(0,0,0, 0.51)] shadow-[0px_-4px_4px_0px_rgb(0,0,0, 0.51)] dark:border-dashcolor/50 border-[0.1px] border-primary/30">
    ...
    >
      ...
      <CUButton v-if="route.path === '/auth/forgot-password'"  @click="router.push('/')" label="Retour a l'accueil" class="w-full justify-center" size="lg" logoPosition="right" />
    </div>
  </div>
</template>
