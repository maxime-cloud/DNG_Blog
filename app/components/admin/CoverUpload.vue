...
<template>
  <div>
    ...
    >
      <img :src="modelValue" alt="Couverture" class="w-full h-40 object-cover" />
      <button
    ...
    <label
      class="flex items-center justify-center gap-2 w-full py-3 border-[0.1px] border-dashed border-dashcolor/50 hover:border-dashcolor cursor-pointer transition-colors text-sm text-zinc-500 hover:text-white"
