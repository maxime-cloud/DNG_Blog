          ...
          <div class="flex-1 relative bgHero flex flex-col">
            <div class="flex-1 min-h-[80vh] max-h-[80vh] flex flex-col justify-center items-center relative bgPoint">
              <div class="flex flex-col justify-center items-center gap-4 z-10 ">
                <h1 class="text-[24px] sm:text-[32px] lg:text-[40px] font-bold text-center">Solution En <span class="dark:bg-[#DEDEDE] bg-[#0F0F0F] opacity-85 text-[#DEDEDE] dark:text-[#414141] px-1">Développement Web</span> Et <br class="block sm:hidden md:block"/> <span class="dark:bg-[#DEDEDE] bg-[#0F0F0F] opacity-85 text-[#DEDEDE] dark:text-[#414141] px-1">Intelligence Artificielle</span></h1>
                ...
                <p class="text-sm sm:text-[16px] lg:text-lg text-center dark:text-[#F3F4F6]/80 text-[#0F0F0F]/80">Même si vous ne travaillé pas dans la tech, vous trouver des article pour vous aidé</p>
