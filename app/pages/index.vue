    ...
    <BaseLayaoutContent :home="true">
      <div class="content flex flex-col min-h-[85vh] relative">
        <div class="flex-1 relative bgHero flex flex-col">
          <div
            class="flex-1 min-h-[80vh] max-h-[80vh] flex flex-col justify-center items-center relative bgPoint"
          >
            <div class="flex flex-col justify-center items-center gap-4 z-10">
              <h1 class="text-[24px] sm:text-[32px] lg:text-[40px] font-bold text-center">
                Tutoriels techniques en
                <span
                  class="dark:bg-[#DEDEDE] bg-[#0F0F0F] opacity-85 text-[#DEDEDE] dark:text-[#414141] px-1"
              ...
              <p
                class="text-sm sm:text-[16px] lg:text-lg text-center dark:text-[#F3F4F6]/70 text-[#0F0F0F]/70"
              >
