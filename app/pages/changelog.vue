...
const typeColors: Record<string, string> = {
  FEATURE: 'text-green-400 bg-green-950',
  FIX: 'text-red-400 bg-red-950',
  CONTENT: 'text-blue-400 bg-blue-950',
  DESIGN: 'text-purple-400 bg-purple-950',
  PERF: 'text-orange-400 bg-orange-950',
  SECURITY: 'text-yellow-400 bg-yellow-950'
}
    ...
    <BaseLayaoutContent>
      <div class="py-10 px-4 max-w-3xl mx-auto">
        ...
        <p class="text-zinc-500 mb-10">
          Historique des mises à jour du blog.
        </p>
        <div class="space-y-6">
          <div
